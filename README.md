...
EDCBのサービス化の有無や権限まわりで動作が変わる点については、[EDCB連携時の実行コンテキストとトラブルシューティング](./doc/EDCBLaunchContext.md)にまとめてあります。「録画後に何も起きない」「サーバーがエラーを吐く」場合はこちらを確認してください。
