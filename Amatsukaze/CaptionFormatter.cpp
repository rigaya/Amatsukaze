...
std::wstring CaptionASSFormatter::generate(const std::vector<OutCaptionLine>& lines) {
    sb.clear();
...
std::wstring CaptionSRTFormatter::generate(const std::vector<OutCaptionLine>& lines) {
    sb.clear();
    subIndex = 1;
    prevEnd = -1;
    prevPosY = -1;
